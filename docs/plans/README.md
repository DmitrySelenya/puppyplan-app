...
| --- | --- | --- | --- |
| Active task plan | [Household Invite — Make The Second Family Member Actually Join](active/2026-07-23-household-invite-design.md) | `PUP-42` | Phase 0 — migration/ADR RED |
