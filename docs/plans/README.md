...
| --- | --- | --- | --- |
| Active task plan | [Household Invite — Make The Second Family Member Actually Join](active/2026-07-23-household-invite-design.md) | `PUP-42` | Preflight / Senior Pass Gate 1; awaiting owner approval for TDD mode, copy dependency, baseline timer fix, and accepted-household activation |
