...
| --- | --- | --- | --- |
| Active roadmap | [Architecture Foundation Roadmap](active/2026-05-21-phase-0-architecture-cleanup.md) | Split through `PUP-2`, `PUP-3`, `PUP-4`, `PUP-5`, and follow-up issues | Do not assign directly; scaffold, Supabase/RLS, local/CI gates, and Quick Log planning are complete; start Quick Log implementation with `PUP-11` |
...
2. Start Quick Log implementation with `PUP-11`, then continue through `PUP-12` to `PUP-16` as dependencies are satisfied.
