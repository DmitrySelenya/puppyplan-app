...
| --- | --- | --- | --- |
| Active roadmap | [Full PRD Native App Master Roadmap](active/2026-05-29-full-prd-native-app-master-roadmap.md) | `PUP-17` | External review fixes applied; first implementation slice is split out as `PUP-18` on its own branch, while route/design coverage can parallelize only as synthetic/non-production wiring |
