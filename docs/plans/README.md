...
| --- | --- | --- | --- |
| Active task plan | [Dogfood Diary Follow-Ups (2026-07-21)](active/2026-07-21-dogfood-diary-followups.md) | `PUP-38` | Phases 0/A/B done (hero CTA, silent uncheck, subtle sync dot); Phase C slow-sync investigation + device verification next |
