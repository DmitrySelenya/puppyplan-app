...
| --- | --- | --- | --- |
| Active task plan | [Dogfood Device Handoff — From Green Simulator To Two Household iPhones](active/2026-07-12-dogfood-device-handoff.md) | `PUP-32`, `PUP-30` physical acceptance | Blocked in Phase 3 — third authorized sweep records repeat-chip PASS but an in-scope Diary time-chrome FAIL; owner decision required |
