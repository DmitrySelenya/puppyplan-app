...
| Active task plan | [PUP-3 Supabase Contracts And RLS Baseline](active/2026-05-24-pup-3-supabase-contracts-rls-baseline.md) | `PUP-3` | Non-production dev DB has PUP-3 migrations through `20260525135121`; generated DB types are in review; remaining work is the final GitHub remote pgTAP/typegen gate rerun |
