      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '8px 24px 24px', display: 'flex', flexDirection: 'column' }}>
        ...
        <div
          ...
          style={{
            ...
            boxShadow: '0 12px 32px rgba(28,31,27,0.10), 0 0 0 1px var(--pp-stroke)',
            overflow: 'hidden',
        ...
        >
          ...
          <div style={{
            ...
            <div style={{
              ...
              background: 'var(--pp-accent-300)', color: 'var(--pp-accent-700)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: 56, fontWeight: 600, letterSpacing: -2,
              boxShadow: '0 6px 16px rgba(28,31,27,0.12)',
            }}>L</div>
          </div>
