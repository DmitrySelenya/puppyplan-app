...
function ScreenReminderPush() {
  return (
    <Phone>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', background: '#1A1815', color: '#fff' }}>
        {/* Lock-screen time */}
    ...
    <Phone>
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '4px 16px 96px' }}>
        ...
        <List>
          ...
          <ListRow leading={<Icon name="info.circle" size={22} />} title="About" subtitle="Version 1.0.0 (beta)" chevron />
        </List>
        ...
        <List>
          <ListRow
            ...
            subtitle="Extended features for the first 90 days"
            chevron
          />
        </List>
      </div>
  ...
  return (
    <Phone>
      ...
      <div style={{
        ...
        <Field value="DELETE" focused />
        <div style={{ height: 16 }} />
        <Button variant="destructive-filled" block>Delete</Button>
    ...
    <Phone>
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '8px 24px 24px' }}>
        ...
        <div className="pp-body" style={{ color: 'var(--pp-text-secondary)', marginBottom: 24 }}>
          Extended features for the first 90 days.
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 20 }}>
          <PlanCard label="Yearly" sub="€49.99 · save 53%" recommended />
...
function PlanCard({ label, sub, recommended }) {
  return (
    <div style={{
      padding: 16,
      borderRadius: 12,
      background: recommended ? 'var(--pp-primary-50)' : 'var(--pp-surface-raised)',
      border: recommended ? '2px solid var(--pp-primary-500)' : '1px solid var(--pp-stroke)',
      display: 'flex', justifyContent: 'space-between', alignItems: 'center',
      position: 'relative',
    }}>
      <div>
        <div className="pp-headline" style={{ color: recommended ? 'var(--pp-primary-800)' : 'var(--pp-text-primary)' }}>{label}</div>
        <div className="pp-footnote" style={{ color: recommended ? 'var(--pp-primary-700)' : 'var(--pp-text-tertiary)', marginTop: 2 }}>{sub}</div>
      </div>
      {recommended ? (
        <div style={{
        ...
        <div style={{ width: 22, height: 22, borderRadius: 999, border: '1.5px solid var(--pp-stroke-strong)' }} />
      )}
    </div>
  );
}
