  ...
  return (
    <Phone>
      <div className="pp-navbar">
        ...
        <Pill tone="warning" icon="ui.checkmark.seal" style={{ background: '#F7EAD2', color: '#7E5A18' }}>Sitter</Pill>
      </div>
        ...
        <List>
          {[
            ...
            <ListRow
              ...
              // Completed = checkbox + muted text. Strikethrough removed (review
              // pass 3, P2 — reads as «cancelled», conflicts with calm tone).
              title={<span style={{ color: 'var(--pp-text-tertiary)' }}>{c.label}</span>}
              trailing={<Icon name={c.icon} size={20} color="var(--pp-text-tertiary)" />}
            />
          ))}
        </List>
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '0 16px 96px' }}>
        ...
        <Card padding={0} style={{ overflow: 'hidden' }}>
          <div style={{ display: 'flex' }}>
            {/* Neutral stroke instead of amber rail — the sitter-mode pill above
                already carries the «active» signal; amber added an unnecessary
                tense tone. Review pass 3, P1. */}
            <div style={{ width: 4, background: 'var(--pp-stroke)' }} />
            <div style={{ flex: 1, padding: 18 }}>
              ...
              {/* Progress — primary (teal). 3 of 6 mid-day is normal progress,
                  not a warning; warning color is reserved for «overdue & unmarked».
                  Review pass 3, P1. */}
              ...
              >
                <div style={{ width: '50%', height: '100%', background: 'var(--pp-primary-500)' }} />
              </div>
  ...
  return (
    <Phone>
      ...
      <div style={{
        ...
        {/* Primary (teal), not destructive-filled. Ending sitter mode does NOT
            delete data — Caregiver A stays as caregiver. Red filled is reserved for
            Delete account / Delete entry. Review pass 3, P1. */}
        <Button variant="primary" block>End sitter mode</Button>
