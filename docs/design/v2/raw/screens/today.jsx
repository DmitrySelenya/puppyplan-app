...
//
// Canonical mock day (review pass 3, P2 — mock-data sync):
//   Day 1 — Thursday, May 14, 2026 (= DOB Mar 19 + 8 weeks 0 days → «8 weeks»)
//   Day 2 — Friday,   May 15, 2026 (8 weeks 1 day → «8 weeks»)
//   Day 7 — Wednesday May 20, 2026 (8 weeks 6 days → «9 weeks»)
// Stays in lockstep with profile.jsx (DOB Mar 19, 2026 ≈ 8 weeks at day 1).

// ──────────────────────────────────────────────────────────
// Shared Today scaffolding
// ──────────────────────────────────────────────────────────
function TodayHeader({ name = 'Puppy A', age = '8 weeks', date = 'Thursday · May 14', members }) {
  return (
    <>
...
function ScreenTodayDay2() {
  return (
    <Phone>
      <TodayHeader date="Friday · May 15" />
      <div style={{ flex: 1, overflow: 'auto', padding: '0 16px var(--pp-bottom-inset-fab)' }}>
        <HeroCard
          eyebrow="NOW"
...
function ScreenTodayDay7() {
  return (
    <Phone>
      <TodayHeader name="Puppy A" age="9 weeks" date="Wednesday · May 20" />
      <div style={{ flex: 1, overflow: 'auto', padding: '0 16px var(--pp-bottom-inset-fab)' }}>
        <HeroCard
          eyebrow="NOW"
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '0 16px var(--pp-bottom-inset-fab)' }}>
        ...
        <List>
          ...
          <ListRow
            ...
            title="Dmitry got back from a walk"
            subtitle="1 hr ago"
            chevron
          />
        </List>
        ...
        <Card>
          <div className="pp-callout" style={{ color: 'var(--pp-text-secondary)' }}>With you: Caregiver A, Dmitry, you.</div>
        </Card>
      </div>
      <TabBar active="today" />
      <FAB />
...
function ScreenTodayLoading() {
  return (
    <Phone>
      <TodayHeader />
      <div style={{ flex: 1, overflow: 'hidden', padding: '0 16px var(--pp-bottom-inset-fab)' }}>
        <Card>
          <Skel w="70%" h={20} />
          <div style={{ height: 8 }} />
          <Skel w="90%" h={14} />
