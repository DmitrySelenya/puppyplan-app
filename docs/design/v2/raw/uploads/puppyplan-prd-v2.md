...
**1. Опекун A, 29, solo first-time owner.**
...
**2. Опекун B и Опекун A, 32 и 31, shared care.**
...
**3. Опекун C, 35, владелец, работающий с trainer/kinologist.**
...
**4. Опекун D, 38, parent managing family care.**
Дети помогают со щенком, но не являются пользователями приложения. Опекуну D нужен спокойный dashboard, task visibility и простая account model.

**5. Опекун E, 64, retired companion-dog owner.**
...
**6. Опекун F, 34, foster/rescue volunteer.**
...
- household activity strip: "Опекун A покормила Щенка A 42 мин назад";
...
**After invite.**
- owner видит last-action strip с attribution: "Опекун A покормила Щенка B 12 мин назад";
...
- app показывает, кто что сделал, например "Опекун A покормила Щенка B 12 мин назад";
...
- owner видит completion updates in-app, например "Щенок B накормлен"; push completion notifications разрешены только как узкий trusted-sitter сценарий, а не как broad household activity push;
...
- copy: "Опекун A уже логировала feeding 12 минут назад. Все равно добавить?";
...
- owner видит completion update вроде "Щенок B накормлен" in-app; push notification отправляется только если trusted-sitter completion push включен и permission получен.
...
**Age hint**
> Ого, Щенку B уже 5 месяцев. В этом возрасте у многих щенков активно меняются зубы - держите chew toys под рукой и сверяйте вопросы здоровья с ветеринаром.

**Duplicate feeding warning**
> Опекун A залогировала feeding 12 минут назад. Все равно добавить еще одно feeding?
...
> Щенок B накормлен. Опекун G отметила feeding 4 минуты назад.
