  ...
  return (
    <Phone>
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '8px 16px 32px' }}>
        <SectionHeader action="Add member">Family</SectionHeader>
        <List>
          <ListRow
        ...
        <div style={{ height: 20 }} />
        <SectionHeader action="Invite">Petsitter & trainer</SectionHeader>
        <List>
          <ListRow
            leading={<Avatar initial="A" size="lg" tone="sunken" />}
            title="Anya"
            subtitle="Petsitter · access until May 21"
            trailing={<Pill tone="info" icon="person.solo">Sitter</Pill>}
            chevron
          />
        </List>
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '8px 16px 24px' }}>
        ...
        <List>
          <ListRow
            ...
            title="Petsitter"
            subtitle="Hands-on daily care while you're away"
          />
          <ListRow
            leading={<div style={{ width: 22, height: 22, borderRadius: 999, border: '1.5px solid var(--pp-stroke-strong)', background: '#fff' }} />}
            title="Trainer"
            subtitle="Follows training progress, adds notes"
          />
        </List>

        <div style={{ height: 20 }} />
        <SectionHeader>What the petsitter will see</SectionHeader>
        <Card>
          <div className="pp-callout" style={{ marginBottom: 8, color: 'var(--pp-text-secondary)' }}>This access includes:</div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {["Today's routine and reminders", 'Log feedings, walks, potty breaks', 'Care checklist and instructions', 'Emergency vet contact'].map(b => (
          ...
          <div className="pp-footnote" style={{ color: 'var(--pp-text-secondary)' }}>
            Won't see: health history, training notes, billing, private notes
          </div>
        </Card>

        <div style={{ height: 20 }} />
        <SectionHeader>Access window</SectionHeader>
        <Field label="Access until" value="May 21" trailing={<Icon name="chevron.down" size={18} color="var(--pp-text-secondary)" />} />
        <div className="pp-footnote" style={{ color: 'var(--pp-text-secondary)', marginTop: 6 }}>
          Petsitter access ends automatically on this date.
        </div>
    ...
    <Phone>
      ...
      <div style={{ flex: 1, padding: '8px 16px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div className="pp-body" style={{ color: 'var(--pp-text-secondary)', textAlign: 'center', marginBottom: 28 }}>
          dmitry@email.com · Caregiver · expires May 21
        </div>
        <div style={{ width: '100%', marginBottom: 16 }}>
          <Banner tone="info" icon="lock.shield">Revoking makes the link unavailable immediately.</Banner>
        </div>
...
function ScreenTrainerScope() {
  const scopes = [
    ...
    { title: 'Diary history range', incl: 'events of the selected types on the selected days', excl: 'free-text notes you didn\'t mark as shareable', on: false },
                ...
                <div style={{ flex: 1, padding: 14 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 }}>
                    <div style={{ flex: 1 }}>
                      ...
                      {s.defaultOff && <div className="pp-footnote" style={{ color: 'var(--pp-text-secondary)', marginTop: 2 }}>This item is off by default.</div>}
                    </div>
                    <Toggle on={s.on} />
                  </div>
                  <div style={{ marginTop: 10, display: 'flex', flexDirection: 'column', gap: 6 }}>
                    <div className="pp-footnote"><span style={{ color: 'var(--pp-success)' }}>Includes: </span>{s.incl}</div>
                    <div className="pp-footnote"><span style={{ color: 'var(--pp-text-secondary)' }}>Not included: </span>{s.excl}</div>
                  </div>
                </div>
              </div>
            </Card>
  ...
  return (
    <Phone>
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '8px 16px 24px' }}>
        ...
        <div style={{ height: 16 }} />
        <Field label="Send to" value="trainer@email.com" />
        <div style={{ height: 12 }} />
        <Field label="Expiry" value="30 days" trailing={<Icon name="chevron.down" size={18} color="var(--pp-text-secondary)" />} />
        <div style={{ height: 12 }} />
        <Banner tone="info" icon="lock.shield">You can close access at any time.</Banner>
      </div>
    </Phone>
  ...
  return (
    <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
      ...
      <div style={{ flex: 1 }}>
        ...
        {subtitle && <div className="pp-footnote" style={{ color: 'var(--pp-text-secondary)', marginTop: 1 }}>{subtitle}</div>}
      </div>
    </div>
  );
}
...
function ScreenTrainerAccepted() {
  return (
    <Phone>
      <div className="pp-navbar" style={{ borderBottom: '1px solid var(--pp-stroke-hair)' }}>
        <span style={{ width: 28 }} />
        <span className="pp-nav-title">Luna</span>
        <span style={{ width: 28 }} />
      </div>
      <div style={{ padding: '4px 16px 12px' }}>
        <div className="pp-large-title" style={{ padding: 0 }}>Luna</div>
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '0 16px 24px' }}>
        ...
        <Card padding={0}>
          <div style={{ padding: 14 }}>
            ...
            <div className="pp-footnote" style={{ color: 'var(--pp-text-secondary)', marginTop: 2 }}>15 min · indoor</div>
          </div>
          <div className="pp-divider" />
          <div style={{ padding: 14 }}>
            <div className="pp-headline">May 11 · "Loose-leash walking"</div>
            <div className="pp-footnote" style={{ color: 'var(--pp-text-secondary)', marginTop: 2 }}>10 min · garden</div>
          </div>
        </Card>
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
      ...
      <span>
        ...
        <span className="pp-footnote pp-mono" style={{ color: 'var(--pp-text-secondary)', marginLeft: 6 }}>{sub}</span>
      </span>
    </div>
  );
}
    ...
    <Phone>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '0 32px', textAlign: 'center' }}>
        <div style={{
          ...
          <Icon name="lock.shield" size={42} stroke={1.5} color="var(--pp-text-secondary)" />
        </div>
        ...
        <div className="pp-body" style={{ color: 'var(--pp-text-secondary)', marginBottom: 32 }}>
          Contact the owner if you need new access. This message looks the same for expired, revoked, and invalid links.
        </div>
