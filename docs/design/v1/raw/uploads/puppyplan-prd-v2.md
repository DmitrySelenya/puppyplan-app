...
**After invite.**
- owner видит last-action strip с attribution: "Опекун A покормила Щенок Aа 12 мин назад";
...
- app показывает, кто что сделал, например "Опекун A покормила Щенок Aа 12 мин назад";
...
- copy: "Опекун A уже логировала feeding 60 секунд назад. Все равно добавить?";
...
**Age hint**
> Ого, Щенок Aу уже 5 месяцев. В этом возрасте у многих щенков активно меняются зубы - держите chew toys под рукой и сверяйте вопросы здоровья с ветеринаром.

**Duplicate feeding warning**
> Опекун A залогировала feeding 60 секунд назад. Все равно добавить еще одно feeding?
...
> Щенок A накормлен. Ситтер A отметила feeding 4 минуты назад.
