...
function TimelineHeader({ filter = 'All' }) {
  const chips = ['All', 'Potty', 'Food', 'Sleep', 'Zoomies', 'Training', 'Health'];
  return (
    <>
  ...
  return (
    <Phone>
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '0 0 96px' }}>
        ...
        <Card padding={0} style={{ margin: '0 16px' }}>
          <TimelineEvent time="20:10" icon="feeding.walk" title="Walk · 22 min" actor="Caregiver B"
