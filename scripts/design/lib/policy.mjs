...
export const forbiddenTextPatterns = [
  ...
  {
    pattern:
      /(?:Аня|Марк|Оля|Оли|Лена|Ирина|Ирины|Ирине|Ирину|Ириной|Томаш|Сара|Сары|Саре|Сару|Сарой|Дмитрия|Дмитрию|Дмитрий|Луна|Луну|Бублика|Бублику|Бублик|Марина)/g,
    reason: "use synthetic role/puppy placeholders instead of personal names",
  },
  {
