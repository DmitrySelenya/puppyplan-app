...
test("Spanish strings avoid known high-risk machine-translation regressions", () => {
  ...
  const expectedValues = new Map([
    ...
    ["timeline.filter-chips.2", "Alimentación"],
    ["timeline.filter-chips.3", "Sueño"],
    ["timeline.filter-chips.4", "Paseo"],
    ["timeline.filter-chips.5", "Zoomies"],
    ["timeline.filter-chips.6", "Salud"],
    ...
    ["paywall.plan-yearly", "Anual · 39,99 $"],
    ...
    ["tabs.diary-hint", "Abre la pantalla Diario"],
    ["tabs.pet-hint", "Abre la pantalla Mascota"],
