...
export const shellI18nKeys = [
  ...
  'timeline.delete-confirm.body',
  'timeline.delete-confirm.primary',
  'timeline.delete-confirm.secondary',
  ...
  'reminders.lifecycle.mutation-error-title',
  'reminders.lifecycle.open-actions-template',
  'health.tab-title',
  'health.pet-hub.a11y',
  ...
  'health.states.loading.status',
  'health.states.loading.title',
  'health.states.loading.body',
  'health.states.error.status',
  'health.states.error.title',
  'health.states.error.body',
  'health.states.offline-read.status',
  'health.states.offline-read.title',
  'health.states.offline-read.body',
  ...
  'health.vet-prep.add-item-unavailable',
  ...
  'more.notifications.quiet-hours-value-unavailable',
  'more.notifications.quiet-hours-unavailable',
  'more.notifications.timezone-auto-hint',
  'more.privacy.screen-title',
  'more.privacy.section-consents',
  'more.privacy.row-analytics',
  'more.privacy.analytics-hint',
  'more.privacy.section-errors',
  'more.privacy.row-error-reports',
  'more.privacy.errors-hint',
  'more.privacy.consents-unavailable',
  'more.privacy.section-your-data',
  'more.privacy.row-export',
  'more.privacy.section-account',
  'more.privacy.section-account-removal',
  'more.privacy.row-delete',
  'more.privacy.export-sheet',
  'more.privacy.delete-sheet.title',
  'more.privacy.delete-sheet.body',
  'more.privacy.delete-sheet.confirm-input-prompt',
  'more.privacy.delete-sheet.confirm-input-word',
  'more.privacy.delete-toast',
  ...
  'more.help.topic-guidance.quick-log',
  'more.help.topic-guidance.sharing',
  'more.help.topic-guidance.privacy',
  ...
  'sharing.family.accepted.action-unavailable',
  ...
  'sharing.family.manage.actions-unavailable',
  ...
  'sharing.sitter.unavailable-title',
  'sharing.sitter.unavailable-body',
